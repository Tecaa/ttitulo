...
<!-- begin:content -->
						...
						<div class="col-md-5 col-sm-5">
							<div id="itemsingle" class="carousel slide clearfix">
								...
								<ol class="carousel-indicators">
								  <li data-target="#itemsingle" data-slide-to="0" class="active">{{ HTML::image("img/manuk.jpg", "Foto 2", array('class' => 'img-responsive'))  }}</li>
            ...
            <div class="col-md-7 col-sm-7">
              ...
              <p>Código de Producto : <span class="label label-warning">#{{$producto->codigo_producto}}</span></p>
              <h4>{{$producto->precioVentaF}}</h4>
              
              <p>Cantidad<input type="number" name="cantidad" value=1 min=1 max=20><a id="comprar" class="btn btn-warning btn-large" data-cod-producto={{$producto->codigo_producto}} ><i class="icon-shopping-cart"></i> Comprar</a></p>
            </div>

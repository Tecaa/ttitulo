@section('content')
	...
	<div class="heads" style="background: url(../img/img02.jpg) center center;">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2><span>//</span> Crear vendedor</h2>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="page-content">
        ...
        <!-- begin:product-sidebar -->
              ...
              <ul class="dropdown-menu sub-menu">
                  ...
                  <li><a href="product.html">Categoríaas</a></li>
                ...
                <div class="col-md-15">
                  <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="email" class="form-control" placeholder="Dirección : " required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" placeholder="f o m : " required>
                      </div>
                    </div>
